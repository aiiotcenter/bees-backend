...
# Configuration
API_URL      = "https ://100.125.227.62:9602/api/records"
...
def send_status_update_direct(hive_id: int, status: bool):
    ...
    """
    status_url = f"https://100.125.227.62:9602/api/hives/status/{hive_id}"
...
def send_location_data_direct(latitude, longitude):
    ...
    """
    location_url = "https://100.125.227.62:9602/api/hives/check-location/1"
    location_data = {
        "latitude": latitude,
        "longitude": longitude
    }
